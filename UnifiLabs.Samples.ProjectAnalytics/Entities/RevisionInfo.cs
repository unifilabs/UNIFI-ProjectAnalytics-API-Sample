...
namespace UnifiLabs.Samples.ProjectAnalytics.Entities {
    public class RevisionInfo {
        ...
        [JsonProperty("numericRevisionInfo")] public NumericRevisionInfo NumericRevisionInfo { get; set; }

        [JsonProperty("numberingStyle")] public string NumberingStyle { get; set; }

        [JsonProperty("revisionCloudSpacing")] public double RevisionCloudSpacing { get; set; }
