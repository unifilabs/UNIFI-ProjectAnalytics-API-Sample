...
namespace ProjectAnalytics.Entities
{
    public partial class Data
    {
        ...
        [JsonProperty("sharedParameterFile")]
        ...
        [JsonProperty("projectFamilies")]
        public ProjectFamilies ProjectFamilies { get; set; }

        [JsonProperty("systemFamilies")]
        public SystemFamilies SystemFamilies { get; set; }

        [JsonProperty("draftingViews")]
        public object[] DraftingViews { get; set; }
        ...
        [JsonProperty("planRegions")]
        public object[] PlanRegions { get; set; }
