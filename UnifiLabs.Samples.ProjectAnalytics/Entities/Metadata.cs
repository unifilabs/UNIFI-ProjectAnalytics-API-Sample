...
namespace UnifiLabs.Samples.ProjectAnalytics.Entities {
    public class Metadata {
        ...
        [JsonProperty("collectedFromEvent")] public string CollectedFromEvent { get; set; }

        [JsonProperty("saveDuration")] public long SaveDuration { get; set; }

        [JsonProperty("syncWithCentralDuration")]
        public double SyncWithCentralDuration { get; set; }

        [JsonProperty("revitProjectIds")] public string[] RevitProjectIds { get; set; }
    }
}